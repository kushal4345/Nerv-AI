...
const transcribeAudio = async (audioBlob: Blob): Promise<string> => {
  try {
    ...
    const apiKey = import.meta.env.VITE_APP_AZURE_WHISPER_API_KEY as string;
    const endpoint = `${import.meta.env.VITE_APP_AZURE_WHISPER_ENDPOINT}/openai/deployments/whisper/audio/translations?api-version=${import.meta.env.VITE_APP_AZURE_WHISPER_API_VERSION}`;
