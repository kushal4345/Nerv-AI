        ...
        <div className="flex space-x-1 px-6">
          {[
            ...
            <button
              ...
              className={`flex items-center space-x-2 py-4 px-4 rounded-t-lg transition-all duration-300 group ${
                activeTab === tab.id
                          ...
                          <div key={index} className="flex items-center justify-between p-4 bg-gray-700/30 rounded-lg border border-gray-600/30">
                            <div className="flex items-center space-x-3">
                              <div className={`w-3 h-3 rounded-full ${
                                round.performance === 'Excellent' ? 'bg-green-500' :
                                ...
                                <div className="w-16 bg-gray-600 rounded-full h-1">
                                  <div 
                                    className={`h-1 rounded-full ${
                                      round.confidence >= 80 ? 'bg-green-500' :
                      ...
                      <div className="w-full bg-gray-600 rounded-full h-3">
                        <div 
                          className={`h-3 rounded-full transition-all duration-700 ${
                            q.confidence >= 80 ? 'bg-gradient-to-r from-green-500 to-green-400' :
